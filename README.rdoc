...
This is it. If you want to test +err_merchant+ in development mode, make sure to set +config.consider_all_requests_local+ to +false+ and restart your development server.
